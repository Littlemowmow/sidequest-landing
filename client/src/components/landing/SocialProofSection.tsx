    ...
    <section className="py-10 overflow-hidden" data-testid="section-social-proof">
      <div className="relative">
        ...
        <div className="flex gap-4 animate-marquee whitespace-nowrap">
          {[...trips, ...trips].map((t, i) => (
            <div key={i} className="inline-flex items-center gap-2.5 bg-white/5 px-5 py-2.5 rounded-full border border-white/10 cursor-default select-none" data-testid={`text-trip-${i}`}>
